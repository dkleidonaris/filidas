							...
							<tr>
								...
								>
									...
									<div style="background-color: #f1f5f9; padding: 8px">
										<h2 style="margin-top: 8px; margin-bottom: 8px">{{__('Στοιχεία πελάτη')}}</h2>
									...
									>&zwj;</div>
									<div style="background-color: #f1f5f9; padding: 8px">
										<h2 style="margin-top: 8px; margin-bottom: 8px">{{__('Στοιχεία κράτησης')}}</h2>
										<div style="position: relative; overflow-x: auto">
											<table
												class="rtl-text-right dark-text-gray-400"
												style="border-collapse: collapse; width: 100%; text-align: left; font-size: 14px; color: #6b7280"
									...
									<div
										...
										style="line-height: 20px"
									>&zwj;</div>
									<p style="margin-bottom: 16px">Επισκεφτείτε τη σελίδα διαχείρισης της
										κράτησής σας για να προβείτε σε πληρωμή:</p>
									<div style="display: flex; justify-content: center">
										<a
											href="{{ $button_url }}"
									...
									>
										Με εκτίμηση,
										<br>
										<span style="font-weight: 600">Χρήστος</span>
										<br>
										<span>FILIDAS Apartments</span>
									</p>
								</td>
							</tr>
						</table>
							...
							<tr>
								...
								>
									<p style="margin: 0; font-size: 12px; color: #64748b">
										&copy; 2025 {{__('Διαμερίσματα FILIDAS')}}. All rights reserved.
									</p>
								</td>
							</tr>
						</table>

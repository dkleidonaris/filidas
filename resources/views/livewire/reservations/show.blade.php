...
new class extends Component {
    ...
    {
        $this->version = 2;
        $this->mid = config('nexi.merchant_id');
...
<div class="mx-auto max-w-4xl p-2 pb-[100px]">
    ...
    <div class="mt-4 rounded-md bg-slate-300 p-2">
        ...
        <div
            class="flex flex-col gap-4 overflow-x-auto rounded-md bg-white p-2">
        ...
        <div
            class="mt-4 flex flex-col gap-2 rounded-md border-2 border-white p-2">

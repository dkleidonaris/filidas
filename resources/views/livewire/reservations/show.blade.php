			...
			<div class="flex flex-row gap-2">
				@if ($deposit - $amount_payed > 0)
					<p
						...
						class="cursor-pointer rounded-md bg-blue-500 p-2 text-white"
...
@script
	<script>
		Livewire.on('submit-payment-form', (event) => {
			...
			document.getElementsByName('orderDesc')[0].value = data.orderDesc;
			...
			document.getElementsByName('confirmUrl')[0].value = data
				.confirmUrl;
			document.getElementsByName('cancelUrl')[0].value = data.cancelUrl;
